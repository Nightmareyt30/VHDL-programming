...
REM
REM Generated by Vivado on Sun May 31 00:33:17 +0530 2026
...
echo "xvhdl --incr --relax -prj mux2_1_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj mux2_1_tbw_vhdl.prj -log xvhdl.log
