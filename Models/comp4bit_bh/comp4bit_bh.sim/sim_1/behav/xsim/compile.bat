...
REM
REM Generated by Vivado on Mon Jun 01 22:17:28 +0530 2026
...
echo "xvhdl --incr --relax -prj comp4bit_bh_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj comp4bit_bh_tbw_vhdl.prj -log xvhdl.log
