...
REM
REM Generated by Vivado on Tue Jun 02 07:13:16 +0530 2026
...
echo "xvhdl --incr --relax -prj ALU_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj ALU_tbw_vhdl.prj -log xvhdl.log
