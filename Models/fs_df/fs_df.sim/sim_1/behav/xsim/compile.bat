...
REM
REM Generated by Vivado on Sun May 31 12:40:24 +0530 2026
...
echo "xvhdl --incr --relax -prj fs_df_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj fs_df_tbw_vhdl.prj -log xvhdl.log
