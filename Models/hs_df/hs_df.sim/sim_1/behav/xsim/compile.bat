...
REM
REM Generated by Vivado on Mon Jun 01 23:51:05 +0530 2026
...
echo "xvhdl --incr --relax -prj hs_df_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj hs_df_tbw_vhdl.prj -log xvhdl.log
