...
REM
REM Generated by Vivado on Tue Jun 02 06:59:01 +0530 2026
...
echo "xvhdl --incr --relax -prj d_bh_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj d_bh_tbw_vhdl.prj -log xvhdl.log
