...
REM
REM Generated by Vivado on Tue Jun 02 05:37:28 +0530 2026
...
echo "xvhdl --incr --relax -prj jk_bh_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj jk_bh_tbw_vhdl.prj -log xvhdl.log
