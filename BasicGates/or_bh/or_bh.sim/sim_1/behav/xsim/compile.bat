...
REM
REM Generated by Vivado on Sat May 30 23:51:14 +0530 2026
...
echo "xvhdl --incr --relax -prj or_bh_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj or_bh_tbw_vhdl.prj -log xvhdl.log
