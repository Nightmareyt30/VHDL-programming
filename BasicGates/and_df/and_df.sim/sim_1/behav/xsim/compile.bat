...
REM
REM Generated by Vivado on Sat May 30 23:39:28 +0530 2026
...
echo "xvhdl --incr --relax -prj and_df_tbw_vhdl.prj"
call xvhdl  --incr --relax -prj and_df_tbw_vhdl.prj -log xvhdl.log
